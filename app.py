...
model = YOLO(r'F:\insighteye\datacenter\yolov8n.pt')

video = cv2.VideoCapture(r'F:\insighteye\datacenter\Road_Traffic_Monitoring-main\traffic.mp4')
...
out = cv2.VideoWriter('F:/insighteye/datacenter/Road_Traffic_Monitoring-main/traffic_output.mp4', fourcc, 30.0, (width, height))
...
up_img = cv2.imread(r'F:\insighteye\datacenter\Road_Traffic_Monitoring-main\up.png', cv2.IMREAD_UNCHANGED)
up_img = cv2.resize(up_img, (50, 50))
down_img = cv2.imread(r'F:\insighteye\datacenter\Road_Traffic_Monitoring-main\down.png', cv2.IMREAD_UNCHANGED)
